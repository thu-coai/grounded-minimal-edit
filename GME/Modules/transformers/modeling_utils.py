...
class PreTrainedModel(nn.Module):
    ...
    @classmethod
    def from_pretrained(cls, pretrained_model_name_or_path, **kwargs):  # TODO: modified by Authors.
        ...
        # TODO: added by Authors. [start]
        config.is_decoder = kwargs.pop('is_decoder')
        transformer_layers = kwargs.pop('transformer_layers')
        if transformer_layers != 'default':
            if hasattr(config, 'n_layer'):  # gpt2.
        ...
        config.pad_id = kwargs.pop('pad_id')
        # TODO: added by Authors. [end]
        ...
        if from_tf:
            if resolved_archive_file.endswith('.index'):
                ...
                try:
                    from . import load_tf2_checkpoint_in_pytorch_model
