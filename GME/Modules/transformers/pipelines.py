...
from . import (AutoConfig, AutoTokenizer, PreTrainedTokenizer,
...
if is_tf_available():
    ...
    from . import TFAutoModel, TFAutoModelForSequenceClassification, \
        TFAutoModelForQuestionAnswering, TFAutoModelForTokenClassification

if is_torch_available():
    import torch
    from . import AutoModel, AutoModelForSequenceClassification, \
